...
ax.set_xlabel('iterations')
ax.set_ylabel('Cost')
ax.set_title("Planar Hand (Move Right)", fontsize=title_font_size)
ax.grid()
...
ax.set_xlabel('iterations')
# ax.set_ylabel('Cost (log scale)')
ax.set_title("Planar Hand (Spin In-hand, Second-Order Sim)", fontsize=title_font_size)
ax.grid()
...
ax = axes[1, 2]
ax.plot(exact[0:-2], marker='x', color='red', label='exact')
ax.plot(first_order[0:-2], marker='v', color='springgreen', label='first order')
ax.plot(zero_order[0:-2], marker='^', color='blue', label='zero order')
ax.legend()
ax.set_xlabel('iterations')
# ax.set_ylabel('Cost')
...
ax = axes[1, 3]
ax.plot(exact[0:6], marker='x', color='red', label='exact')
ax.plot(first_order[0:6], marker='v', color='springgreen', label='first order')
ax.plot(zero_order[0:6], marker='^', color='blue', label='zero order')
ax.legend()
ax.set_xlabel('iterations')
# ax.set_ylabel('Cost')
